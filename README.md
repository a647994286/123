...
```bash
# ETTh1
python -u main_pgot.py --model informer --data ETTh1 --attn prob --freq h

# ETTh2
python -u main_pgot.py --model informer --data ETTh2 --attn prob --freq h

# ETTm1
python -u main_pgot.py --model informer --data ETTm1 --attn prob --freq t
```
